...
func main() {
	...
	productsStore := dbstore.NewProductStore(
		dbstore.NewProductStoreParams{
			Products: []products.Product{},
		},
	)

	go func() {
		err := productsStore.LoadProducts()
		if err != nil {
			logger.Error("Error loading products", slog.Any("err", err))
		}
	}()
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/cartpanda", handlers.NewCartpandaHandler(handlers.CartpandaHandlerParams{
